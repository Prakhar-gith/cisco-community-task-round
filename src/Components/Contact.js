  ...
  render() {
    return (
      <div style={{ background: 'black', padding: '20px' }}>
        <h1 style={{ textAlign: 'center', color: 'white' }}>Connect with Us</h1><br/>
        <h5 style={{ textAlign: 'center', color: 'white' }}>Socials</h5><br/>
        <div className="d-flex justify-content-center">
          <div className="card mx-1" style={{ width: '8.7rem', background:'black', color:'white', borderRadius:"20px" }}>
            <img
          ...
          <div className="card mx-1" style={{ width: '9.5rem', background:'black', color:'white',  borderRadius:"20px"}}>
            <img
              src="/images/yt.png"
              className="card-img-top mx-auto d-block"
              alt="..."
              style={{ height: '35px', width:'40px', objectFit: 'cover' }}
            />
            <div className="card-body" style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div className="card mx-3" style={{ width: '8rem' , background:'black', color:'white',  borderRadius:"20px"}}>
            <img
          ...
          <div className="card mx-1" style={{ width: '8rem', background:'black', color:'white', borderRadius:'20px'}}>
            <img
              src="./images/ig.jpg"
              className="card-img-top mx-auto d-block"
              alt="..."
              style={{ height: '50px', width: '49px',objectFit: 'cover' }}
            />
            <div className="card-body" style={{ display: 'flex', flexDirection: 'column' }}>
